...
SECRET_KEY = 'django-insecure-xy1_5$rst!rqx^qy(li_1^fp53gl2f#-#8#l)aq3ei2u9_yh*f'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Join API',
    'DESCRIPTION': 'A simple API for User registration and authorization for the kanban app join',
    'VERSION': '1.0.0',
